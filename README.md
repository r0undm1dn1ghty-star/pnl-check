...
## Конкурентная сверка e-commerce 17.09.2026

Баттлтест #3 (цикл 2): сравнительная сверка «прибыль vs деньги» по трём публичным игрокам e-commerce РФ за FY2025 — Ozon, Wildberries & Russ, Яндекс Маркет. Результат: [`examples/competition-ecommerce-2026-09-17.md`](examples/competition-ecommerce-2026-09-17.md).

| Компания | Выручка 2025 | Чистый результат | OCF | Долг | Evidence | Вердикт |
|---|---|---|---|---|---|---|
| **Ozon** | 998,0 млрд ₽ (+63%) | −0,9 млрд ₽ (2024: −59,4) | +503,6 млрд ₽ (вкл. финтех) | ЧД не раскрыт | Confirmed (unaudited) | ⚠️ Частично |
| **Wildberries & Russ** | н/д по группе; РСБУ юрлица 1 187,0 | +175 млрд ₽ группа (МСФО); РСБУ юрлица +55,3 | **−376,6 млрд ₽ (РСБУ юрлица!)** | кредиты 830,5 (+696%) | Mixed | ❌ Data gap |
| **Яндекс Маркет** (сегмент e-com) | сегмент 465,3 (+44%); группа 1 441,1 (+32%) | группа +79,6; сегмент −39,6 EBITDA | группа +282,3 | ЧД/EBITDA 0,2× | Confirmed (audited) | ✅ Да |

**Главный вывод:** «прибыль есть, денег нет» — РВБ: прибыль юрлица +55,3 млрд ₽ при
отрицательном денежном потоке текущих операций −376,6 млрд ₽ и долге, выросшем ×8.
Убыточный сегмент Яндекса растёт быстрее всех (+44%) и покрывается денежной машиной группы.
У Ozon прибыль и деньги почти сошлись, но OCF требует сегментного разреза (финтех).
